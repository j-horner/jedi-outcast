...
//---------------------------------------------------------
{
	...
	gi.G2API_InitGhoul2Model( missile->ghoul2, weaponData[static_cast<int>(WP_DET_PACK)].missileMdl, G_ModelIndex( weaponData[static_cast<int>(WP_DET_PACK)].missileMdl ), NULL_HANDLE, NULL_HANDLE, 0, 0);
