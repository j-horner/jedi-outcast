...
void SP_misc_model_cargo_small( gentity_t *ent )
{
	...
	SetMiscModelDefaults( ent, useF_NULL, const_cast<char*>("11"), CONTENTS_SOLID|CONTENTS_OPAQUE|CONTENTS_BODY|CONTENTS_MONSTERCLIP|CONTENTS_BOTCLIP, 0, qtrue, qfalse );
