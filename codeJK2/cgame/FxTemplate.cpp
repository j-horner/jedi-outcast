...
//------------------------------------------------------
bool CPrimitiveTemplate::ParseFloat( const std::string_view& val, float& min, float& max )
{
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseVector( const std::string_view& val, vec3_t min, vec3_t max )
{
...
namespace detail
{
	...
	struct ScanStrings
	{
		...
		static int call( const std::string_view& val, std::array< std::string_view, count >& arr, Args&... args )
		{
...
static std::span< std::string_view > scanStrings( const std::string_view& val, std::array< std::string_view, count >& arr )
{
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseGroupFlags( const std::string_view& val, int& flags )
{
	// For a sub group, really you probably only have one or two flags set
	std::array< std::string_view, 4 > flag;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseMin( const std::string_view& val )
{
	vec3_t min;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseMax( const std::string_view& val )
{
	vec3_t max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseLife( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseDelay( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseCount( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseElasticity( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseOrigin1( const std::string_view& val )
{
	vec3_t min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseOrigin2( const std::string_view& val )
{
	vec3_t min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseRadius( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseHeight( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseRotation( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseRotationDelta( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseAngle( const std::string_view& val )
{
	vec3_t min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseAngleDelta( const std::string_view& val )
{
	vec3_t min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseVelocity( const std::string_view& val )
{
	vec3_t min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseFlags( const std::string_view& val )
{
	// For a primitive, really you probably only have two or less flags set
	std::array< std::string_view, 7 > flag;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSpawnFlags( const std::string_view& val )
{
	std::array< std::string_view, 7 > flag;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseAcceleration( const std::string_view& val )
{
	vec3_t min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseGravity( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseDensity( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseVariance( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseRGBStart( const std::string_view& val )
{
	vec3_t min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseRGBEnd( const std::string_view& val )
{
	vec3_t min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseRGBParm( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseRGBFlags( const std::string_view& val )
{
	int flags;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseAlphaStart( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseAlphaEnd( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseAlphaParm( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseAlphaFlags( const std::string_view& val )
{
	int flags;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSizeStart( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSizeEnd( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSizeParm( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSizeFlags( const std::string_view& val )
{
	int flags;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSize2Start( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSize2End( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSize2Parm( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseSize2Flags( const std::string_view& val )
{
	int flags;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseLengthStart( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseLengthEnd( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseLengthParm( const std::string_view& val )
{
	float min, max;
...
//	success of parse operation.
//------------------------------------------------------
bool CPrimitiveTemplate::ParseLengthFlags( const std::string_view& val )
{
	int flags;
