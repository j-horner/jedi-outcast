...
//------------------------------------------------------
int SFxHelper::RegisterShader( const std::string_view& shader )
{
...
//------------------------------------------------------
int SFxHelper::RegisterSound( const std::string_view& sound )
{
	// TODO: it would be nice to change the ABI here to allow for passing of string views
...
//------------------------------------------------------
int SFxHelper::RegisterModel( const std::string_view& model )
{
